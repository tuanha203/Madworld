...
const NftSellCard: FC<INftSellCard> = (props) => {
  const {
    collectionName = '',
    nftName = '',
    nftImage,
  ...
  return (
    <div className="w-full lg:px-0 px-3">
      ...
      <div className="flex justify-between">
        <div className="flex">
          <div className="w-[65px] h-[65px] mx-auto rounded-lg overflow-hidden flex items-center justify-center">

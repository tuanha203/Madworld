...
const FlagshipCard: FC<ICardCommon> = ({
  dataNFT,
  styles,
  type,
  className,
    ...
    <LoadingBase loading={loading}>
      <div className="relative">
        ...
        <div className="relative z-[2] box-shadow-card">
          <div
            style={{border: `1px solid ${text?.color}`}}
            className={`${className} p-4 font-Chakra flagship-card-common h-full product-detail-card sm:w-[100%] background-[none] hover:bg-secondary-ref shadow-elevation-dark-1 hover:shadow-elevation-dark-5 relative flex flex-col`}
          >
            ...
            {/* <div className="clip-path-image-nft"> */}
                <a style={{background: text?.color}} className="flagship-card-bg mb-5 flex items-center justify-center">
                  <div className="m-[1px] flagship-card-img bg-background-dark-1000 overflow-hidden w-full h-full">
                    <figure
                      style={styles ? styles.image : {}}
                      className="relative overflow-hidden h-[114px] lg:h-[230px] flex items-center justify-center cursor-pointer"
                    >
...
export default memo(FlagshipCard);

  ...
  return (
    <div>
      <ModalFollowStep
        ...
        classCustom="max-h-[85vh] md:!w-[562px] !w-[90%] md:!px-[64px] !px-3"
      >
        <div className="font-Chakra">
          <div className="pb-8">
            <NftSellCard
              ...
              nftImage={get(assetDataDetail, 'nftImagePreview', '')}
              nftUrl={get(assetDataDetail, 'nftUrl', '')}
          ...
          <div className="overflow-y-auto max-h-[50vh] mb-[10px]">
            ...
            <div ref={approveRef} className="flex p-4 rounded-lg mb-4 cursor-pointer bg-background-sell-step-popup-selected">
              ...
              <div className="flex-1">
                <div className="flex justify-between">
                  <div className="font-bold text-dark-on-surface">3. Approve this item for sale</div>
                  <div className="p-2">
                    <img
                      src="/icons/arrow-bottom.svg"
                      className={`relative bottom-1 text-primary-dark ml-3`}
            ...
            <div ref={signRef} className="flex  p-4 rounded-lg mb-4 cursor-pointer bg-background-sell-step-popup-selected">
              ...
              <div className="flex-1">
                <div className="flex justify-between">
                  <div className="font-bold text-dark-on-surface">
                    4. Confirm {formatNumber(data?.amount)} {data?.currency} listing
                  </div>
                  <div className="p-2">
                    <img
                      src="/icons/arrow-bottom.svg"
...
export default ModalFollowStepAuction;

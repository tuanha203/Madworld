...
const ModalSellDutchAuction = ({
  ...
  useEffect(() => {
    if (isWaitingForSign) {
      ...
      setCollapsed({ ...collapsed, approve: true, listing: true });
      setTimeout(() => {
  ...
  const isEthCurrency = data?.staringCurrency?.toUpperCase() === 'ETH';
      ...
      >
        <div className="font-Chakra">
          ...
          <div className="overflow-y-auto h-[45vh] mb-[10px]">
            ...
            {!isEthCurrency && (
              <div
                className="flex  p-4 rounded-lg mb-4 cursor-pointer bg-background-sell-step-popup-selected p-5"
              >
                <div className="pr-3 pl-1 w-10">
                  {isUserRegisteredProxy ? (
                    isApproveUMAD ? (
                ...
                <div className="flex-1">
                  <div className="flex justify-between">
                    <div className="font-bold text-dark-on-surface">
                      3. Approve {data?.staringCurrency} token
                    </div>
                    <div className="p-2">
                      <img
                        src="/icons/arrow-bottom.svg"
                  ...
                  {collapsed.approve && (
                    <div className="pr-2">
                      <div className="text-primary-gray lg:text-sm text-xs mt-2">
                        ...
                        to use your {data?.staringCurrency}.
                      </div>
                      {
                        !isApproveUMAD && (
                          <div className="text-xs text-secondary-gray mt-3 mb-3">
            ...
            >
              <div className='"pr-3 pl-1 w-10'>
                ...
                {isEthCurrency && isUserRegisteredProxy && !isWaitingForSign && (
                  <CircularProgressIndicator size={20} />
                )}
                {isEthCurrency && isUserRegisteredProxy && isWaitingForSign && (
                  <CheckIcon style={{ color: '#F4B1A3' }} />
              ...
              <div className="flex-1">
                <div className="flex justify-between">
                  <div className="font-bold text-dark-on-surface">
                    {isEthCurrency ? '3' : '4'}. Confirm {formatNumber(data?.staringPrice)} {data?.staringCurrency}{' '}
                    listing
                  </div>
                  <div className="p-2">
                    <img
          ...
          {/* <div className="lg:text-sm text-xs lg:px-0 px-3">
            Please wait for creating NFT. This will take a while. Please don't reload the current
            page.
          </div> */}
        </div>
      </ModalFollowStep>
...
export default ModalSellDutchAuction;
